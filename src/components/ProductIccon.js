                            ...
                            <div classNameName='product_container' >
                                ...
                                <div className="flex flex-row ">
                                    <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                                        ...
                                        {/* <h6>Summary: &nbsp; {x?.overview}</h6> */}


                                        {/* {showMore ? x?.overview : `${x?.overview.replace(/<\/?[^>]+(>|$)/g, "")?.substring(0, 150)}`} &nbsp;
                                        <button className="btn">Show more</button> */}

                                        {/* <p className="text-gray-700 text-base mb-4" onClick={() => navigate(`${x?.homepage_url}`)} >Homepage</p> */}
                                        {/* <div className="text-gray-700 text-base mb-4" onClick={() => window.open(`${x?.homepage_url}`, '_blank')}>Homepage</div> */}
